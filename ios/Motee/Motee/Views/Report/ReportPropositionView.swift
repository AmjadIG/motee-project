...
struct ReportPropositionView: View {
    ...
    var body : some View {
        ...
        return AnyView(ZStack {
            ...
            VStack(spacing: 20) {
                ...
                HStack{
                    Button(action: {self.fk.showPropositionReport = false ; self.fk.propositionReported = nil}) {
                        Text("Annuler")
                            .bold()
                            .padding(.vertical)
                            .frame(maxWidth: .infinity)
...
struct ReportPropositonView_Previews: PreviewProvider {
